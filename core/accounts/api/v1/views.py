...
class RegistrationApiView(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            email_obj = EmailMessage('email/activation_email.tpl', {'token': token}, 'Joffrykind@gmail.com', to=[email])    
...
class ChangePasswordApiView(generics.GenericAPIView):
    ...
    def put(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            # set password also hashed the password that the user will get
...
class EmailTestSend(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        self.email = "elon@gmail.com"
        user_obj = get_object_or_404(User, email=self.email)
        token = self.get_tokens_for_user(user_obj)
        email_obj = EmailMessage('email/hello.tpl', {'token': token}, 'Joffrykind@gmail.com', to=[self.email])
    ...
    def get(self, request, token, *args, **kwargs):
        ...
        try:
           ...
           user_id = token.get('user_id')
            ...
            return Response({"detail":"token is not Invalid"}, status=status.HTTP_400_BAD_REQUEST)
...
class ActivationResendApiView(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
            ...
            token = self.get_tokens_for_user(user_obj)
            email_obj = EmailMessage('email/activation_email.tpl', {'token': token}, 'Joffrykind@gmail.com', to=[user_obj.email])
            EmailThread(email_obj).start()
